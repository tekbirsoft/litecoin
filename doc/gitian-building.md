...
*Setup instructions for a Gitian build of Husamcoin Core using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Husamcoin
...
- [Building Husamcoin Core](#building-husancoin-core)
...
Building Husamcoin Core
----------------

To build Husamcoin Core (for Linux, OS X and Windows) just follow the steps under 'perform
