...
### Husancoin maintainers/release engineers, suggestion for writing release notes
...
### Build and sign Husancoin Core for Linux, Windows, and OS X:
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the husancoin.org server.
...
- Announce the release:
  ...
  - Optionally twitter, reddit /r/Husancoin, ... but this will usually sort out itself
