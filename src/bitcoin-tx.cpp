...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s husancoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  husancoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded husancoin transaction") + "\n" +
              "  husancoin-tx [options] -create [commands]   " + _("Create hex-encoded husancoin transaction") + "\n" +
              "\n";
