...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.husancoin.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.husancointools.com", true);
        vSeeds.emplace_back("dnsseed.husancoinpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.husancointools.com", true);
        vSeeds.emplace_back("seed-b.husancoin.loshan.co.uk", true);
